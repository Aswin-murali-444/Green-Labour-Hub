...
<ul class="pcoded-item pcoded-left-item">
    ...
    <div class="page-block">
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10" style="font-size: 24px;">Farmer Information</h5>
                    <p class="m-b-0" style="font-size: 18px;"> Details </p>
                </div>
            </div>
        </div>
    </div>
        ...
        <form>
            ...
            // Fetch all data from tbl_farmer
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<label for="farmer_id">Farmer ID:</label>';
                    echo '<input type="text" class="form-control" id="farmer_id" value="' . $row["farmer_id"] . '" readonly>';
                    echo '</div>';

                    echo '<div class="form-group">';
                    echo '<label for="user_id">User ID:</label>';
                    echo '<input type="text" class="form-control" id="user_id" value="' . $row["user_id"] . '" readonly>';
                    echo '</div>';

                    echo '<div class="form-group">';
                    echo '<label for="password">Password:</label>';
                    echo '<input type="text" class="form-control" id="password" value="' . $row["password"] . '" readonly>';
                    echo '</div>';

                    echo '<div class="form-group">';
                    echo '<label for="phone">Phone:</label>';
                    echo '<input type="text" class="form-control" id="phone" value="' . $row["phone"] . '" readonly>';
                    echo '</div>';

                    echo '<div class="form-group">';
                    echo '<label for="gender">Gender:</label>';
                    echo '<input type="text" class="form-control" id="gender" value="' . $row["gender"] . '" readonly>';
                    echo '</div>';

                    echo '<div class="form-group">';
                    echo '<label for="address">Address:</label>';
                    echo '<input type="text" class="form-control" id="address" value="' . $row["address"] . '" readonly>';
                    echo '</div>';

                    echo '<div class="form-group">';
                    echo '<label for="name">Name:</label>';
                    echo '<input type="text" class="form-control" id="name" value="' . $row["name"] . '" readonly>';
                    echo '</div>';
                }
            } else {
                echo "<p>No farmer details found.</p>";
            }
