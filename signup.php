...
if(isset($_POST['signup'])){
    ...
    $check_query = "SELECT * FROM tbl_farmer WHERE user_id='$email' AND password='$pass'";
...
<head>
  ...
  <style>
    /* Custom styles to adjust input width */
    .swal2-input {
        width: 100%;
                ...
                success: function (response) {
                    if (response == "matched") {
                        Swal.fire({
                            ...
                            window.location.href = 'login_det_farmer.php';
                        });
                    } else {
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu active" aria-labelledby="servicesDropdown">
                      <!-- Dropdown items go here -->
                      <a class="dropdown-item " href="farmerlogin.php">Worker</a>
                      <a class="dropdown-item active" href="signup.php">Farmer</a>
                  </div>
              </li>
              </ul>
            </div>
          ...
          <div class="signup-content">
            <div class="signup-image">
              ...
              <div class="signup-form">
                  <h2 class="form-title"> Farmer Sign up</h2>
...
function validateEmail() {
    ...
    if (email.trim() === '') {
        ...
        return false;
    } else if (!emailRegex.test(email) || /^\d+@/.test(email)) {
